...
def openEmbed():
    ...
    embedOut = tk.Text(eTab, width=65, height=2, font=("Consolas",12),bg="#111827", fg="#7dd3fc", insertbackground="white",
    ...
    def downloadEmb():
      if getattr(eTab, "imgPath", None) is None:
...
def setupGUI():
    ...
    button(bFrame, "📝 Embed Image", "#ec4899", "#db2777", openEmbed).grid(row=0, column=2, padx=10)
